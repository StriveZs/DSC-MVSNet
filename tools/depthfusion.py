...
if __name__ == '__main__':
    ...
    parser.add_argument("-v", '--view_num', type=int, default=48)
    parser.add_argument("-n", '--name', type=str, default='flow2')
    ...
    for scene in scene_list:
        ...
        filter_dirs = list(filter(lambda x:x.startswith("2333"), cur_dirs))
